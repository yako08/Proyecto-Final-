...
el un rol tiene que ser para los usuarios, este les permitira entrar al canal donde se encuentra eco bot
el otro rol es para que el bot pueda mandar mensajes 
